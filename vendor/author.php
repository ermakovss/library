...
<body>
	...
	<section class="create">
		...
		<div class="container">
			...
			<div class="create__title books__title--head popylarity__title">Добавьте нового автора</div>

			<form action="createAuthor.php" method="post">
				<input type="text" name="author" class="author__input">
	...
	<div class="container container__title">
		<div class="create__title books__title--head popylarity__title">Список авторов</div>
	</div>
		...
		<div class="container">
			...
			<table class="author__table">
				...
				<tr>
					<td><?= $counter ?></td>
					<td><?= $item[1] ?></td>
					<td><a href ="deleteAuthor.php?id=<?= $item[0] ?>"> Удалить </a></td>
				</tr>
